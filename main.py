...
def main():
    ...
    while True:
        ...
        if lms:
            ...
            # New distracted actions: Detecting specific head poses for drinking, eating, or using a phone
            using_phone = yaw is not None and abs(yaw[0]) > 30
            drinking = pitch is not None and pitch[0] > 20
            eating = roll is not None and abs(roll[0]) > 15
